        ...
        <div class="ui form">
            ...
            <div class="two fields">
                <div class="field" :class="$v.address.firstName.$error ? 'form-group--error error' : ''">
                    ...
                    <div class="ui red pointing prompt label" v-if="!$v.address.firstName.required">First name is required.</div>
                </div>
                <div class="field" :class="$v.address.lastName.$error ? 'form-group--error error' : ''">
                    ...
                    <div class="ui red pointing prompt label" v-if="!$v.address.lastName.required">Last name is required.</div>
                </div>
            </div>
            <div class="field" :class="$v.address.address.$error ? 'form-group--error error' : ''">
                ...
                <div class="fields" >
                    <div class="twelve wide field">
                        ...
                        <div class="ui red pointing prompt label" v-if="!$v.address.address.required">Street address is required.</div>
                    </div>
            ...
            <div class="three fields">
                <div class="five wide field" :class="$v.address.city.$error ? 'form-group--error error' : ''">
                    ...
                    <div class="ui red pointing prompt label" v-if="!$v.address.city.required">City is required.</div>
                </div>
                <div class="four wide field" :class="$v.address.state.$error ? 'form-group--error error' : ''">
                    ...
                    <div class="ui red pointing prompt label" v-if="!$v.address.state.required">State is required.</div>
                </div>
                <div class="four wide field" :class="$v.address.zipcode.$error ? 'form-group--error error' : ''">
                    ...
                    <div class="ui red pointing prompt label" v-if="!$v.address.zipcode.required">Zipcode is required.</div>
                    <div class="ui red pointing prompt label" v-if="!$v.address.zipcode.zipcode">You must provide a valid zipcode.</div>
                </div>
            </div>
            <div class="two fields">
                <div class="six wide field" :class="$v.address.email.$error ? 'form-group--error error' : ''">
                    ...
                    <div class="ui red pointing prompt label" v-if="!$v.address.email.required">Email is required.</div>
                    <div class="ui red pointing prompt label" v-if="!$v.address.email.email">You must provide a valid email address.</div>
                </div>
                <div class="six wide field" :class="$v.address.phone.$error ? 'form-group--error error' : ''">
                    ...
                    <div class="ui red pointing prompt label" v-if="!$v.address.phone.required">Phone is required.</div>
                    <div class="ui red pointing prompt label" v-if="!$v.address.phone.minLength">Please enter a valid phone number.</div>
                </div>
            </div>
            <div>
